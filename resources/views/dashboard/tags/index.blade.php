          ...
          <table class="w-full">
            ...
            <tbody class="bg-white">
              ...
              <tr class="text-gray-700">
                ...
                <td class="px-4 py-3 text-ms font-semibold border">{{$tag->name}}</td>
                <td class="px-4 py-3 text-xs border">{{$tag->slug}}</td>
                <td class="px-4 py-3 text-sm border">{{$tag->created_at->format('d/m/Y')}}</td>
                <td class="px-4 py-3 text-sm border">{{$tag->updated_at->format('d/m/y')}}</td>
